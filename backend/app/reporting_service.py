...
OBJECTIVES_SUMMARY_EXPORT_HEADERS = [
    "Objective Code",
    "Submissions with Objective",
    "Complete Submissions",
    "Incomplete Submissions",
    "Total Awarded (Complete)",
    "Total Max (Complete)",
    "Average Awarded (Complete)",
    "Average Percent (Complete)",
    "Total Awarded (All Current)",
    "Total Max (All Current)",
    "Average Percent (All Current)",
    "Strongest Complete Student",
    "Strongest Complete Percent",
    "Weakest Complete Student",
    "Weakest Complete Percent",
    "Teacher Summary",
]
...
STUDENT_SUMMARY_MANIFEST_HEADERS = [
    ...
    "Teacher Marked Questions Count",
    "Total Questions",
    "Marking Progress",
    "Total Awarded",
    "Total Possible",
