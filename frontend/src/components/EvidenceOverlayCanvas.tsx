...
export function EvidenceOverlayCanvas({ imageUrl, evidence, visible }: { imageUrl: string; evidence: EvidenceBox[]; visible: boolean }) {
  return (
    <div style={{ position: 'relative' }}>
      <img src={imageUrl} alt="Key page" style={{ width: '100%', borderRadius: 8 }} />
